...
export default function Driveruifinal() {
                ...
                <div className="container">
                    <div className="row row-dwn">
                        <div className="col-sm-8">
                            <div className="row">
                                <div className="routeinfodiv rcw">
                                    <div className="textt1">Starting Point: {routeInfo.startingPoint}</div>
                                    <br />
                                    <div className="textt1">Destination: {routeInfo.destination}</div>
                                    <br />
